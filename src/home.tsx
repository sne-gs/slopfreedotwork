...
const roles = [
  {
    ...
    company: "Datastar Systems",
    location: "Remote // UTC+8",
    salary: "$140K–$180K",
    type: "Full-time",
    href: "/jobs/senior-frontend-engineer",
  },
  {
    title: "Product Designer",
    company: "Nullpoint Labs",
    location: "Berlin",
    salary: "€70K–$90K",
    type: "Contract",
  ...
  },
  {
    ...
    salary: "$160K–$210K",
    type: "Full-time",
    href: "/jobs/ml-infrastructure-engineer",
  },
  {
    ...
    <div class="flex min-h-screen flex-col bg-base-100 font-sans text-base-content">
      ...
      <footer class="mt-auto border-t border-solid border-base-300 px-6 py-12">
        <div class="grid gap-12 text-xs md:grid-cols-4">
          <div>
            <h4 class="text-[0.65rem] case-upper tracking-[0.25em] text-base-content/60">
              System
            </h4>
            <ul class="mt-6 grid gap-3 text-base-content/60">
              <li>
                <a href="#" class="hover:text-base-content">
                  Documentation
                </a>
              </li>
              <li>
